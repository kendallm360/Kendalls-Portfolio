  ...
  return (
    <section className="AboutMe">
      ...
      <h3 className="Overview">
        I never aim to be the smartest person in a room but I always want to be
        among the hardest workers. I am a great team player but culturally I fit
        best in fast pace environments. Although I am transitioning into this
        industry I believe I am already equipped with a lot of qualities to be
        successful. My experience at the NSA helped me become extremely
